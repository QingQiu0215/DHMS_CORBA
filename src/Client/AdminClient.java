		...
		switch(option) 
		{
			...
			case 2:
			{
				if(clientType=='A')
				{
					...
					{
						String result=QUEobj.bookAppointment(clientID,patientID, appointmentID, appointmentType);
						String resultStr=(result.equalsIgnoreCase("true"))?"Success":"Failed";
						System.out.println(result);
					...
					{
						String result=SHEobj.bookAppointment(clientID,patientID, appointmentID, appointmentType);
						String resultStr=(result.equalsIgnoreCase("true"))?"Success":"Failed";
						System.out.println(result);
			...
			case 5:
			{
				if(clientType=='A') {
					...
					if(clientID.contains("MTL"))
					{
						...
						String resultStr=(resultSwap.equalsIgnoreCase("Successfully swapped"))?"Success":"Failed";
